...
- `.github/pull_request_template.md` exists and is the source for PR body structure.
...
2. Run local validation (`pytest -v --cov=src --cov-report=term-missing`) before pushing.
...
# 3) gh pr create/edit --body-file /tmp/pr_body.md
# 4) python3 scripts/validate_pr_body.py --pr <PR_NUMBER>
